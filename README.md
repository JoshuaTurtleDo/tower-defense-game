...
- **Royal Ballista:** expensive, slow, very long-ranged heavy damage. Its discounted upgrades cost 202 gold for level 2 and 281 gold for its permanent level-three choice.
  - **Flame Bazooka:** fires burning greatbolts. Each hit ignites its target for two seconds, dealing another 50% of the initial damage over that duration. Repeated hits create independent burns.
  - **Zeus's Bow:** launches lightning bolts that stun for 0.2 seconds and shock targets for three seconds. Shocked enemies take 10% increased damage from all sources.
