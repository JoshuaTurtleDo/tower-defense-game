...
- **Tiny Castle:** a 600-gold support defense that empowers combat defenses within a 2-tile radius. Affected defenses gain 20% damage, 20% range, and 20% attack speed. The aura does not stack when a defense is within range of more than one Tiny Castle.
