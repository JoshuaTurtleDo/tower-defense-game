...
const prefersTouchControls = window.matchMedia?.("(pointer: coarse)").matches || navigator.maxTouchPoints > 0;
const gameSettings = { shadows: !prefersTouchControls, healthBars: true, cameraSensitivity: 1 };
...
function spawnEnemy(type, options = {}) {
  ...
  state.enemies.push({
    ...
    bossSummonsMade: 0,
    theftTimer: !bossMinion && base.theftInterval ? base.theftInterval : 0,
    theftRemainder: 0,
    theftPulse: 0,
    blocked: false,
    moving: true,
