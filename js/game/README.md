...
4. `defenses.js` — placing defenses, placement rules, calculated tower stats, standard upgrades, and Gold Mine workers.
...
7. `relics-and-trees.js` — Merchant shop, relic inventory/equipment, and tree removal.
...
13. `input.js` — mouse, camera, keyboard, and button event handlers.
14. `main.js` — the animation loop and one-time startup. This should stay small.
