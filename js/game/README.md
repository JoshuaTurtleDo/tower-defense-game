...
5. `troops.js` — Barracks troops, Zombies, Gladiators, Vampire Minions, Togga's frontline behavior, dragon/witch troop attacks, and friendly-unit movement.
...
8. `control-effects.js` — Ballista burn/shock ailments, Stoneback Ogre throws, Dread Ghost fear, and Umbral possession behavior.
