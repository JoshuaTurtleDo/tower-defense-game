...
const enemyTypes = {
  ...
  davyjones: { ...bossSummonDefaults, name: "Davy Jones", hp: 850, speed: 37, reward: 95, damage: 5, color: "#386d69", physicalResistance: .24, magicResistance: .3, symbol: "DJ", scale: 1.45, barWidth: 54, barOffset: 44, modelScale: 1.45, miniBoss: true },
  moonalpha: { ...bossSummonDefaults, name: "Moonfang Alpha", hp: 1100, speed: 58, reward: 120, damage: 5, color: "#9b938d", physicalResistance: .3, magicResistance: .18, symbol: "A", scale: 1.5, barWidth: 57, barOffset: 46, modelScale: 1.5, miniBoss: true },
  longship: { ...bossSummonDefaults, name: "Viking Longship", hp: 1350, speed: 29, reward: 145, damage: 6, color: "#725037", physicalResistance: .42, magicResistance: .08, symbol: "S", scale: 1.75, barWidth: 64, barOffset: 52, modelScale: 1.72, miniBoss: true },
  covenwitch: { ...bossSummonDefaults, name: "Coven Witch", hp: 1200, speed: 35, reward: 155, damage: 5, color: "#7558a5", physicalResistance: .12, magicResistance: .58, symbol: "✦", scale: 1.48, barWidth: 57, barOffset: 48, modelScale: 1.48, miniBoss: true },
  riftlord: { ...bossSummonDefaults, name: "Rift Overlord", hp: 1800, speed: 27, reward: 210, damage: 8, color: "#7d202b", physicalResistance: .4, magicResistance: .4, symbol: "R", scale: 1.85, barWidth: 70, barOffset: 57, modelScale: 1.78, miniBoss: true }
};
...
const waves = [
  ...
  { name: "Ride of the Headless Horseman", units: mix([["goblin", 18], ["skeleton", 20], ["orc", 18], ["ogre", 10], ["horseman", 1]], .34) },
...
const waveEvents = {
  6: { name: "Pirate Raid", description: "Cutthroats pour ashore under Davy Jones and an opportunistic Merchant.", type: "pirate", bossType: "davyjones", units: [...sequence("pirate", 14, .2), { type: "davyjones", gap: .72 }, { type: "merchant", gap: .55 }] },
